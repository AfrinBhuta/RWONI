...
header('location:index.php');
	...
	$fid=intval($_GET['fid']);// product id
...
<div class="controls">
<input type="text"  name="username"  value="<?php echo htmlentities($row['username']);?>" class="span8 tip" readonly>
</div>
</div>
...
<div class="controls">
<input type="text"    name="usercontact"  placeholder="Enter Product Name" value="<?php echo htmlentities($row['usercontact']);?>" class="span8 tip" readonly required>
</div>
</div>								
...
<div class="controls">
<input type="text"   name="dname"  placeholder="Enter Donation Name" value="<?php echo htmlentities($row['Donation_name']);?>" class="span8 tip" readonly required>
</div>
</div>
...
<div class="controls">
<textarea  name="location"  placeholder="Enter Location" rows="2" class="span8 tip" required>
...
<div class="control-group">
<label class="control-label" for="basicinput">Specail Note</label>
<div class="controls">
<textarea  name="snote"  placeholder="Enter Special notice" rows="2" class="span8 tip" required>
...
<option value="<?php echo htmlentities($row['vid']);?>"><?php echo htmlentities($row['vname']);?> </option>

...
<head>
	...
	<title>Admin| Allocate Volunteer and area to Donatios</title>
...
<div class="col-md-9">			
								...
								<h3>Allocate Volunteers & Distribution area </h3>
...
$query=mysqli_query($conn,"select donation.*,donater.name as username,donater.email as useremail,donater.contactno as usercontact from donation inner join donater on  donation.userId=donater.id where dis_area is Null");
$cnt=1;
...
?>										
                      ...
                      <?php }
                        ...
                        <?php } ?>
											...
											<td>   <a href="allocation_donation.php?aid=<?php echo htmlentities($row['id']);?>" title="Allocate Voluntter & Area Of Donation" ><i class="icon-edit"></i></a>
												<a href="allocation.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a>
											</td>
											</tr>

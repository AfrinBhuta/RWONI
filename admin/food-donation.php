...
<head>
	...
	<title>Admin| Food Doantion List</title>
...
$query=mysqli_query($conn,"select donation.*,donater.name as username,donater.email as useremail,donater.contactno as usercontact from donation inner join donater on  donation.userId=donater.id where Donation_name='food'");
$cnt=1;
...
?>										
										<tr>
											...
											<td><?php echo htmlentities($row['Food_type']);?></td>
											<td><?php echo htmlentities($row['Food_Quntity']);?></td>
											<td><?php echo htmlentities($row['Food_Hr']);?></td>
                      ...
                      <?php }
                        ...
                        <?php } ?>	 </td>
											...
											<td>    <a href="edit_food.php?fid=<?php echo htmlentities($row['id']);?>" title="Allocate & Upadate Donation" target="_blank"><i class="icon-edit"></i></a>

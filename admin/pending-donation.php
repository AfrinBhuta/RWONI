...
<head>
	...
	<title>Admin| Pending Donations</title>
...
<?php 
$status='0';
$query=mysqli_query($conn,"select donation.*,donater.name as username,donater.email as useremail,donater.contactno as usercontact from donation join donater on  donation.userId=donater.id  where donation.orderStatus='$status'");
$cnt=1;
...
?>										
										<tr>
											...
											<td>
					                          ...
					                          <span style="color: green;">Collect Donation Successfully.</span>
					                        <?php } 
					                      ...
					                      <?php }
											...
											<td>   <a href="update_pending_donation.php?id=<?php echo htmlentities($row['id']);?>" title="Allocate & Upadate Donation" ><i class="icon-edit"></i></a>
												<a href="pending-donation.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a>
											</td>
											</tr>

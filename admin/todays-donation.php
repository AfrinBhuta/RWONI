...
<head>
	...
	<title>Admin| Today Donation</title>
...
$t1="23:59:59";
$to=date('Y-m-d')." ".$t1;
$query=mysqli_query($conn,"select donater.name as username,donater.email as useremail,donater.contactno as usercontact,donation.Donation_name as dname,donation.Location as location,donation.Special_note as snote,donation.orderStatus as orderStatus,donation.orderDate as orderdate,donation.id as id  from donation join donater on  donation.userId=donater.id  where donation.orderDate Between '$from' and '$to'");
$cnt=1;
...
?>										
										<tr>
											...
											<td><?php echo htmlentities($row['snote']);?></td>
                      ...
                      <?php }
                        ...
                        <?php } ?>	 </td>
											...
											<td>    
												<a href="today-donation.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a>
											</td>
											</tr>

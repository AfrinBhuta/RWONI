...
$query=mysqli_query($conn,"insert into donater(name,email,contactno,password) values('$name','$email','$contactno','$password')");
if($query)
{
		...
		<div class="container py-xl-5 py-3">
			<div class="login-body">
				<div class="login p-4 mx-auto">
					...
					<form  role="form" method="post" name="register" autocomplete="off">

...
header('location:index.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($conn,"update donater set name='$name',contactno='$contactno' where id='".$_SESSION['id']."'");
		if($query)
		{
...
{
$sql=mysqli_query($conn,"SELECT password FROM  donater where password='".md5($_POST['cpass'])."' && id='".$_SESSION['id']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($conn,"update donater set password='".md5($_POST['newpass'])."', updationDate='$currentTime' where id='".$_SESSION['id']."'");
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row contact-agileinfo pt-lg-4">
				...
				<div class="col-md-6 address">
					...
					<?php
$query=mysqli_query($conn,"select * from donater where id='".$_SESSION['id']."'");

...
$query=mysqli_query($conn,"SELECT * FROM volunteer WHERE email='$email' and contactno='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{
$extra="forgot-password-vol.php";
mysqli_query($conn,"update volunteer set password='$password' WHERE email='$email' and contactno='$contact' ");
...
?>
						...
						<p class="forgot-w3ls text-center mb-3">
							<a href="volunteer_login.php" class="text-da">Log-In to Your Account</a>
						</p>
